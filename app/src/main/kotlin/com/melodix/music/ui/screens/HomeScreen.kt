...
import com.melodix.music.ui.component.resolveSpotifySectionTitle
import com.melodix.music.viewmodels.SpotifyViewModel
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import com.melodix.music.ui.utils.SnapLayoutInfoProvider
...
fun HomeScreen(
    ...
    LaunchedEffect(useSpotifyHome) {
        if (useSpotifyHome) spotifyViewModel.loadHomeSections()
    }
    ...
    Box(
        ...
        BoxWithConstraints(
            ...
            LazyColumn(
                ...
                if (useSpotifyHome && spotifyHomeSections != null) {
                    spotifyHomeSections?.forEachIndexed { index, section ->
                        ...
                        item(key = "spotify_section_content_$index") {
                            when (section.type) {
                                com.melodix.music.models.SectionType.TRACKS ->
                                ...
                                com.melodix.music.models.SectionType.ARTISTS ->
                                ...
                                com.melodix.music.models.SectionType.PLAYLISTS ->
                                    SpotifyPlaylistSectionRow(
                                        playlists = section.playlists,
                                        onPlaylistClick = { playlist ->
                                            playerConnection.playQueue(
                                                com.melodix.music.playback.queues.SpotifyPlaylistQueue(
                                ...
                                com.melodix.music.models.SectionType.ALBUMS -> {
                                }
                            }
                        }
                    }
