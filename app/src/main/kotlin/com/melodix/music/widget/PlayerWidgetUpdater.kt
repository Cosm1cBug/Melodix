...
object PlayerWidgetUpdater {
    suspend fun update(
        ...
        runCatching {
            ...
            val glanceIds = manager.getGlanceIds(MelodixPlayerWidget::class.java)
            ...
            glanceIds.forEach { glanceId ->
                ...
                MelodixPlayerWidget().update(context, glanceId)
            }
        }.onFailure {
            Timber.tag("PlayerWidgetUpdater").w(it, "Unable to update Melodix player widget")
        }
    }
