...
-keep class com.melodix.music.models.PersistQueue { *; }
-keep class com.melodix.music.models.PersistPlayerState { *; }
-keep class com.melodix.music.models.QueueData { *; }
-keep class com.melodix.music.models.QueueType { *; }
-keep class com.melodix.music.playback.queues.** { *; }
