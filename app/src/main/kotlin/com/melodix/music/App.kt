...
import com.melodix.music.constants.*
import com.melodix.music.extensions.*
...
import com.melodix.music.kugou.KuGou
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(com.melodix.music.utils.GlobalLogTree())
        } catch (_: Exception) {}
