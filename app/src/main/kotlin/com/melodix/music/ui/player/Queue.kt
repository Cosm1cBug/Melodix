...
import com.melodix.music.constants.QueueEditLockKey
...
import com.melodix.music.ui.component.MediaMetadataListItem
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.melodix.music.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.melodix.music.together.TogetherSessionState.Joined).role is com.melodix.music.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.melodix.music.together.TogetherSessionState.Joined
                                                                val isGuest =
                                                                    joined?.role is com.melodix.music.together.TogetherRole.Guest
                                                                if (isGuest) {
