...
import com.melodix.music.widget.PlayerWidgetActions.openAppIntent
...
class MelodixPlayerWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(
        ...
        provideContent {
            ...
            GlanceTheme(colors = MelodixWidgetColors) {
...
private val MelodixWidgetColors =
    ColorProviders(
        light =
            lightColorScheme(
...
private fun PlayerWidgetContent(state: PlayerWidgetState, uiPrefs: WidgetUiPrefs) {
    ...
    val artist = state.artist.ifBlank { "Melodix" }
