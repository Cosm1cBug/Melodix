...
import com.melodix.music.ui.component.LyricsBackgroundType
import com.melodix.music.ui.component.LyricsCardConfig
import com.melodix.music.ui.component.LyricsGlassStyle
import com.melodix.music.ui.component.LyricsLayoutStyle
...
object ComposeToImage {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // Helper: branding Melodix (igual al original)
    // ─────────────────────────────────────────────────────────────────────────
    ...
    private fun drawBranding(
        ...
        val rawLogo   = context.getDrawable(R.drawable.melodix)?.toBitmap(logoSize, logoSize)
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Melodix")
            }
