...
fun IntegrationScreen(
    ...
    val (ytAccountName) = rememberPreference(AccountNameKey, "")
    val (ytAccountEmail) = rememberPreference(AccountEmailKey, "")
    val isYouTubeLoggedIn = remember(innerTubeCookie) { "SAPISID" in innerTubeCookie }
    val ytAccountLabel = ytAccountName.ifEmpty { ytAccountEmail.ifEmpty { "YouTube" } }
    ...
    Column(
        ...
        PreferenceEntry(
            ...
            description = if (isYouTubeLoggedIn) {
                stringResource(R.string.youtube_logged_in_as, ytAccountLabel)
            } else {
                stringResource(R.string.youtube_integration_description)
            },
            icon = { Icon(painterResource(R.drawable.youtube), null) },
            onClick = { navController.navigate("settings/youtube") },
        )

        PreferenceEntry(
            title = { Text(stringResource(R.string.spotify_integration)) },
            description = stringResource(R.string.spotify_login_description),
