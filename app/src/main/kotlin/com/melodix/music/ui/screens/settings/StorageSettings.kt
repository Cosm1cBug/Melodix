...
import com.melodix.music.constants.MaxImageCacheSizeKey
...
import com.melodix.music.extensions.tryOrNull
import com.melodix.music.ui.component.ActionPromptDialog
...
import com.melodix.music.ui.player.CanvasArtworkPlaybackCache
import com.melodix.music.ui.utils.backToMain
import com.melodix.music.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.melodix.music.utils.ArtworkStorage.clear(context)
            }
        }
    }
